export default function DepartmentHelpFooter() {
  return (
    <div className="mt-10 p-6 bg-gradient-to-br from-primary/5 to-transparent rounded-3xl flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border border-primary/5">
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="min-w-0">
          <h4 className="font-bold text-primary">Sáp nhập &amp; phân quyền tổ</h4>
          <p className="text-sm text-on-surface-variant">
            Mỗi tổ gắn với năm học; khi sáp nhập, hệ thống giữ lịch sử và cập nhật danh sách giáo viên tự động.
          </p>
        </div>
      </div>
      <button

...
import SaoDoSidebarNav from './SaoDoSidebarNav.jsx'
import SaoDoTopBar from './SaoDoTopBar.jsx'

export default function SaoDoShell({ activeKey, headerTitle, searchPlaceholder, children }) {
